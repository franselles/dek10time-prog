  ...
  <section class="section">
    <form @submit.prevent="onSubmit">
      ...
      <div class="field">
        ...
        <button type="button" class="button is-small" @click="calculate">
          CALCULAR
        </button>
        <div class="control has-icons-left ">
          <input
      ...
      <div class="field is-grouped">
        <div class="control">
          <button type="submit" class="button is-link">ACEPTAR</button>
        </div>
        <div class="control">
          <button
            type="button"
...
export default {
  ...
  methods: {
    ...mapActions('worktimeStore', ['postTime', 'putTime']),
    onCancel() {
      this.$router.go(-1);
    },
    onSubmit() {
